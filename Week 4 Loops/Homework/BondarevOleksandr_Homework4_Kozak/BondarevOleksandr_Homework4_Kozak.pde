...
3. Now ship shows fire when you press control buttons (updated getSpaceship())
4. Now you can see spaceship legs only when it has landed (updated getSpaceship())
5. Updated Landing field highlighter (getLandingField()): press "L" key to see improved landing field 
  + added more comments in getLandingField
6. Pausing functionality: press "P" key to pause the UFO flight (updated keyPressed() and getSpaceship())
